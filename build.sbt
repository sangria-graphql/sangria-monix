...
libraryDependencies ++= Seq(
  ...
  "io.monix" %% "monix-execution" % "3.2.1",
...
scmInfo := Some(ScmInfo(
  browseUrl = url("https://github.com/sangria-graphql-org/sangria-monix.git"),
  connection = "scm:git:git@github.com:sangria-graphql-org/sangria-monix.git"
))
